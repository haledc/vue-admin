<template>
  <div class="fund-list">
    ...
    <div class="table-container">
      <el-table :data="filterTableData" max-height="450" border style="width: 100%" class="table">
        <el-table-column type="index" label="序号" align="center" width="60"></el-table-column>
        <el-table-column prop="date" align="center" label="创建时间" width="250" sortable>
        ...
        <el-table-column prop="desc" align="center" label="收支描述" width="180"></el-table-column>
