  ...
  <div class="add-fund">
    ...
    >
      <div class="form-container">
        <el-form :model="profileForm" status-icon :rules="rules" ref="profileForm" label-width="80px"
                 class="register-form">
          <el-form-item label="收支类型">
            <el-select v-model="profileForm.type" placeholder="收支类型" prop="type">
          ...
          <el-form-item>
            ...
            <el-button type="primary" @click="submitForm('profileForm')" class="submit-btn">提交</el-button>
          </el-form-item>
        </el-form>
      </div>
    </el-dialog>
